...
public class PrintBrowseHeadings
{
    ...
    private Leech broaderAuthLeech;
    private Leech narrowerAuthLeech;
    ...
    throws Exception
    {
        ...
        if (authPath != null) {
            try {
                ...
                broaderAuthLeech = new Leech(authPath, System.getProperty("field.broader", "broader"));
                narrowerAuthLeech = new Leech(authPath,System.getProperty("field.narrower", "narrower"));
                ...
                broaderAuthLeech = null;
                narrowerAuthLeech = null;
            }
            ...
            if (narrowerAuthLeech != null) {
                IndexReader authReader = DirectoryReader.open(FSDirectory.open(new File(authPath).toPath()));
                authSearcher = new IndexSearcher(authReader);

                loadHeadings(narrowerAuthLeech, out,
                new Predicate() {
                    public boolean isSatisfiedBy(Object obj) {
                        String heading = (String) obj;
                ...
                narrowerAuthLeech.dropOff();
            }

            if (broaderAuthLeech != null) {
                IndexReader authReader = DirectoryReader.open(FSDirectory.open(new File(authPath).toPath()));
                authSearcher = new IndexSearcher(authReader);

                loadHeadings(broaderAuthLeech, out,
                new Predicate() {
                    public boolean isSatisfiedBy(Object obj) {
                        String heading = (String) obj;
